...
class Help(commands.Cog):
    ...
    def _build_help_embed(self, prefix: str) -> discord.Embed:
        ...
        commands_text = (
            ...
            f"`{prefix}extend <time> [@user]` - Add time to a timer\n"
        ...
        examples_text = (
            ...
            f"`{prefix}extend 10m` - Give yourself 10 more minutes\n"
        ...
        help_embed.add_field(
            name="Before You Go",
            value="You get a heads-up before being disconnected, with a button to extend.",
            inline=False
        )
        ...
        help_embed.set_footer(text=f"LastCall v{__version__}")
